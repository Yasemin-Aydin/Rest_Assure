...
import static org.hamcrest.Matchers.*;
    ...
    public class Getting_Started {
        ...
        public void simple_get_request() {
            // Given is something that is prerequisite
            //    When is something when we perform some operation
            //    Then is for validation of the result that is outcome of the operation that we performed
            //    BaseURI-- that we send as a request API link in postman
            //    Get -- endpoint that we get from API link
            //    Status Code-- We put the status code from the result
